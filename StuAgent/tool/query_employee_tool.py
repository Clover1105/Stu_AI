...
from tool.schema.query_employee_schema import QueryEmployeeSchema


@tool(
    description="生成查询员工信息的mysql查询语句，并执行查询语句",
    args_schema=QueryEmployeeSchema
)
def QueryEmployeeTool(sql:str):
    """
    执行 sql 语句查询
    数据库模型：
        表名：employee
...
if __name__ =='__main__':
    print(QueryEmployeeTool.invoke({
